...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT new com.br.LinkTin.LinkTin.model.domain.UserWithUserInfoDTO(u.id, u.name, u.email, u.password, u.cpf, u.address, u.birthDate, u.gender, ui.id, ui.skills, ui.curriculum, ui.level, u.picture) " +
